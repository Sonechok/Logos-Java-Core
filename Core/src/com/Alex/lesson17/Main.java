...
public class Main {
    public static void main(String[] args) {
        ...
        com.Alex.lesson17.Collection collection = new com.Alex.lesson17.Collection(array);
        com.Alex.lesson17.Collection.FirstTask firstTask = collection.new FirstTask();
        com.Alex.lesson17.Collection.SecondTask secondTask = collection.new SecondTask();
        com.Alex.lesson17.Iterator<Number> thirdTask = collection.thirdTask();
        com.Alex.lesson17.Collection.FifthTask fifthTask = new com.Alex.lesson17.Collection.FifthTask(array);
