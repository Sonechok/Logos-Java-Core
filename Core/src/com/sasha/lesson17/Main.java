...
public class Main {
    public static void main(String[] args) {
        ...
        com.sasha.lesson17.Collection collection = new com.sasha.lesson17.Collection(array);
        com.sasha.lesson17.Collection.FirstTask firstTask = collection.new FirstTask();
        com.sasha.lesson17.Collection.SecondTask secondTask = collection.new SecondTask();
        com.sasha.lesson17.Iterator<Number> thirdTask = collection.thirdTask();
        com.sasha.lesson17.Collection.FifthTask fifthTask = new com.sasha.lesson17.Collection.FifthTask(array);
