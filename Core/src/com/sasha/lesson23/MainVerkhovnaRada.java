...
import com.sasha.lesson13.VerkhovnaRada;

import java.util.Scanner;

public class MainVerkhovnaRada {
        ...
        while (isProgramRunning){
            ...
            try{
                ...
                switch (action) {
                    case 1:
                        scanner.nextLine();
                        com.sasha.lesson23.VerkhovnaRada.getInstance().addFactionToArray();
                        break;
                    case 2:
                        scanner.nextLine();
                        com.sasha.lesson23.VerkhovnaRada.getInstance().removeFactionFromArray();
                        break;
                    case 3:
                        scanner.nextLine();
                        com.sasha.lesson23.VerkhovnaRada.getInstance().printAllFaction();
                        break;
                    case 4:
                        scanner.nextLine();
                        com.sasha.lesson23.VerkhovnaRada.getInstance().clearFaction();
                        break;
                    case 5:
                        scanner.nextLine();
                        com.sasha.lesson23.VerkhovnaRada.getInstance().printFaction();
                        break;
                    case 6:
                        scanner.nextLine();
                        com.sasha.lesson23.VerkhovnaRada.getInstance().addDeputyToFraction();
                        break;
                    case 7:
                        scanner.nextLine();
                        com.sasha.lesson23.VerkhovnaRada.getInstance().removeDeputy();
                        break;
                    case 8:
                        scanner.nextLine();
                        com.sasha.lesson23.VerkhovnaRada.getInstance().giveBribe();
                        break;
                    case 9:
                        scanner.nextLine();
                        com.sasha.lesson23.VerkhovnaRada.getInstance().printBribeTakersInFaction();
                        break;
                    case 10:
                        scanner.nextLine();
                        com.sasha.lesson23.VerkhovnaRada.getInstance().printTheBiggestBribeTakersInFaction();
                        break;
                    default:
